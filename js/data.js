...
export const TRANSLATIONS = {
    zh: {
        ...
        advisor: { open: "✨ 问 AI 顾问", title: "AI 香水顾问", subtitle: "基于你的收藏夹回答问题，会综合你的灵魂香调、共现关系和填写的香水名进行推荐。", input_placeholder: "例如：我很喜欢 Le Labo，根据我的口味推荐几款", send: "发送", sending: "思考中…", thinking: "AI 顾问正在思考…", empty: "想问点什么？比如「根据我的喜好推荐三款 Diptyque 的香水」「我夏天可以加一瓶什么香水」「这套调子最适合什么场合？」", error: "回答生成失败，请稍后再试。", empty_collection: "你的收藏夹目前还是空的，AI 顾问会基于空收藏给出泛化建议。", disclaimer: "回答由 AI 生成，仅供参考。", suggestions: ["根据我的口味推荐三款 Le Labo 的香水", "我夏天可以加一瓶什么香水？", "这套调子最适合什么场合？", "和我的灵魂香调相似但更温暖的香水有哪些？"] },
    ...
    en: {
        ...
        advisor: { open: "✨ Ask the AI advisor", title: "AI Fragrance Advisor", subtitle: "Answers grounded in your collection — your soul notes, co-occurrences, and the perfume names you've logged.", input_placeholder: "e.g. I'm into Le Labo — what would I likely enjoy from them?", send: "Send", sending: "Thinking…", thinking: "Advisor is thinking…", empty: "Ask anything — e.g. \"Recommend three Diptyque scents I'd love\", \"What summer perfume should I add?\", \"What occasion suits this profile?\"", error: "Failed to get a reply, please try again.", empty_collection: "Your collection is empty — the advisor will give generic suggestions.", disclaimer: "Replies are AI-generated, for reference only.", suggestions: ["Recommend three Le Labo perfumes for my taste", "What summer perfume should I add?", "What occasion suits this profile?", "Perfumes similar to my soul notes but warmer?"] },
