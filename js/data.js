...
export const TRANSLATIONS = {
    zh: {
        ...
        toast: { saved: "已保存", updated: "已更新", deleted: "已删除", need_name: "请输入香水名称", need_notes: "请至少选择一种气味成分", parsed: "已解析出成分，默认添加到中调，请自行调整", not_found: "未识别出已知成分，请手动添加或检查拼写", voice_unsupported: "您的浏览器不支持语音识别", voice_listening: "正在聆听...", voice_idle: "点击麦克风开始说话", img_analyzing: "正在识别图片成分...", img_done: "识别完成，已提取成分", profile_seeded: "已为你生成默认昵称与头像，可在账户设置中继续调整", profile_saved: "账户设置已保存", avatar_uploaded: "自定义头像已载入，记得保存", avatar_invalid: "请选择 JPG、PNG 或 WEBP 图片", verification_sent: "验证邮件已发送，请前往邮箱查收", verification_checked: "邮箱验证状态已刷新", password_mismatch: "两次输入的新密码不一致", password_updated: "密码已更新", password_need_input: "请填写新密码并确认" }
    },
    en: {
...
export const MOCK_USERS = [
    ...
    { name: "SweetDream", bio: "美食调爱好者", ingredients: ["香草", "焦糖", "巧克力", "杏仁", "零陵香豆"] },
    {
        name: "Bill",
        bio: "偏爱冷杉、茶香和一点潮湿泥土气。",
        ingredients: ["冷杉", "普洱茶", "香根草", "乳香", "橡木苔", "柏树", "愈创木"],
        perfumes: [
            { id: "bill-1", name: "雨林清晨", brand: "Bill", notes: { top: ["冷杉", "柏树"], middle: ["普洱茶", "乳香"], base: ["香根草", "橡木苔"] } },
            { id: "bill-2", name: "木烟茶室", brand: "Bill", notes: { top: ["愈创木"], middle: ["茶叶", "冷杉"], base: ["香根草", "乳香"] } }
        ]
    }
];
