...
export const TRANSLATIONS = {
    zh: {
        ...
        modal: { add_perfume: "添加香水", edit_perfume: "编辑香水", perfume_name: "香水名称", brand: "品牌", top_notes: "前调", middle_notes: "中调", base_notes: "后调", select_placeholder: "点击选择...", select_ingredient: "选择成分", ai_lookup: "✨ AI 自动识别成分", ai_lookup_loading: "AI 识别中…", ai_lookup_hint: "填好名称和品牌后点击，AI 会自动填入前/中/后调，你仍可手动修改。", ai_lookup_need_input: "请先填写香水名称（最好也填品牌）", ai_lookup_no_match: "AI 没有给出可靠的成分，可以手动选择或换个写法再试。", ai_lookup_failed: "识别失败，请稍后重试。", ai_lookup_success: "已自动填入 {0} 个气味成分，可以继续手动调整。", clear_notes: "一键清空", notes_cleared: "已清空所有气味", ai_preview_title: "AI 识别结果", ai_preview_cancel: "取消", ai_preview_apply: "应用到表单", ai_preview_disclaimer: "AI 没有联网检索能力，结果可能不准确，建议核对官方资料后再保存。", confidence_high: "高置信", confidence_medium: "中等置信", confidence_low: "低置信，仅供参考" },
