...
export const TRANSLATIONS = {
    zh: {
        ...
        modal: { add_perfume: "添加香水", edit_perfume: "编辑香水", perfume_name: "香水名称", brand: "品牌", top_notes: "前调", middle_notes: "中调", base_notes: "后调", select_placeholder: "点击选择...", select_ingredient: "选择成分", ai_lookup: "✨ AI 自动识别成分", ai_lookup_loading: "AI 识别中…", ai_lookup_hint: "填好名称和品牌后点击，AI 会自动填入前/中/后调，你仍可手动修改。", ai_lookup_need_input: "请先填写香水名称（最好也填品牌）", ai_lookup_no_match: "AI 没有给出可靠的成分，可以手动选择或换个写法再试。", ai_lookup_failed: "识别失败，请稍后重试。", ai_lookup_success: "已自动填入 {0} 个气味成分，可以继续手动调整。" },
