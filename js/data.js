export const DB = {
    scentProfiles: {
        ...
        "草本": ["薄荷", "罗勒", "迷迭香", "鼠尾草", "百里香", "茶叶", "烟草", "尤加利", "常春藤", "橡木苔", "蓝色洋甘菊", "绿薄荷", "龙蒿", "干草", "青草", "乌龙茶", "马黛茶", "摩洛哥艾蒿", "甜罗勒", "胡椒薄荷", "中式珠茶", "普洱茶", "茶香", "绿茶", "阿萨姆红茶", "茶", "白茶", "艾草", "留兰香", "布枯叶", "草本"],
        "果香": ["苹果", "桃子", "梨", "黑加仑", "无花果", "树莓", "菠萝", "西瓜", "橙子", "黑醋栗", "蜜瓜", "草莓", "青梨", "青苹果", "杏桃", "甜瓜", "樱桃"],
        "树脂": ["琥珀", "乳香", "没药", "安息香", "劳丹脂", "白松香", "灰琥珀", "岩玫瑰树脂"],
        "动物": ["麝香", "龙涎香", "海狸香", "皮革", "海藻", "黑麝香", "花香麝香", "白麝香"],
...
export const SCENT_TRANSLATIONS = {
    ...
    "黑麝香": "Black Musk", "花香麝香": "Floral Musk", "白麝香": "White Musk",
