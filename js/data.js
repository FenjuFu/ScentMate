...
export const TRANSLATIONS = {
    zh: {
        ...
        modal: { add_perfume: "添加香水", edit_perfume: "编辑香水", perfume_name: "香水名称", brand: "品牌", top_notes: "前调", middle_notes: "中调", base_notes: "后调", select_placeholder: "点击选择...", select_ingredient: "选择成分", ai_lookup: "✨ AI 自动识别成分", ai_lookup_loading: "AI 识别中…", ai_lookup_hint: "填好名称和品牌后点击，AI 会自动填入前/中/后调，你仍可手动修改。", ai_lookup_need_input: "请先填写香水名称（最好也填品牌）", ai_lookup_no_match: "AI 没有给出可靠的成分，可以手动选择或换个写法再试。", ai_lookup_failed: "识别失败，请稍后重试。", ai_lookup_success: "已自动填入 {0} 个气味成分，可以继续手动调整。", clear_notes: "一键清空", notes_cleared: "已清空所有气味", ai_preview_title: "AI 识别结果", ai_preview_cancel: "取消", ai_preview_apply: "应用到表单", ai_preview_disclaimer: "结果由 AI 生成，建议核对官方资料后再保存。", ai_preview_citations: "参考来源：", confidence_high: "高置信", confidence_medium: "中等置信", confidence_low: "低置信，仅供参考" },
        auth: { login_tab: "登录", register_tab: "注册", email: "电子邮箱", password: "密码", confirm_password: "确认密码", username: "用户名", login_btn: "登录", register_btn: "立即注册", logging_in: "登录中…", registering: "注册中…", logout_confirm: "确定要退出登录吗？", logout_btn: "退出登录", forgot: "忘记密码？", or: "或", google: "使用 Google 登录" },
        common: { cancel: "取消", save: "保存", done: "完成", all: "全部" },
        advisor: { open: "✨ 问 AI 顾问", title: "AI 香水顾问", subtitle: "基于这一收藏夹的香水、灵魂香调和共现关系回答问题。", input_placeholder: "例如：根据这一收藏夹的口味，推荐几款 Le Labo", send: "发送", sending: "思考中…", thinking: "AI 顾问正在思考…", empty: "想问点什么？比如「根据这一收藏夹推荐三款 Diptyque 的香水」「这套调子最适合什么场合？」「夏天可以再加一瓶什么香水」", error: "回答生成失败，请稍后再试。", empty_collection: "这个收藏夹目前还是空的，AI 顾问会基于空收藏给出泛化建议。", disclaimer: "回答由 AI 生成，仅供参考。", suggestions: ["根据这一收藏夹的口味推荐三款 Le Labo 的香水", "这套调子最适合什么场合？", "夏天可以再加一瓶什么香水？", "和这套灵魂香调相似但更温暖的香水有哪些？"] },
        social_card: { like_hint: "登录并验证邮箱后可点赞", like_need_verify: "请先验证邮箱再点赞", comments_title: "留言", comment_placeholder: "说点什么…", comment_hint: "登录并验证邮箱即可留言", comment_submit: "发送", comment_need_verify: "请先验证邮箱再留言", comment_too_short: "留言太短了，请再多写几个字。", comment_failed: "留言发送失败，请稍后重试。", comment_posted: "已发送", comment_report: "举报", comment_delete: "删除", comment_report_confirm: "确认举报这条留言？举报后将立即对其他用户隐藏。", comment_delete_confirm: "删除自己的留言？", comment_reported: "已举报，留言已隐藏", comment_deleted: "已删除", comment_hidden_tag: "已被举报隐藏", comments_empty: "还没有留言，来做第一个留言的人吧。" },
        feedback: { title: "意见反馈", intro: "告诉我们你想到的优化点、遇到的 bug 或界面建议，提交后会自动同步到 GitHub Issues。", category: "分类", cat_feature: "功能建议", cat_bug: "Bug 反馈", cat_ui: "界面 / 视觉", cat_other: "其他", field_title: "标题", field_desc: "详细描述", field_contact: "联系方式（可选）", submit: "提交反馈", submitting: "提交中…", disclaimer: "提交内容会作为公开 Issue 同步到 GitHub 仓库，请不要填写敏感信息。", success: "已提交，感谢反馈！", success_with_link: "已创建 Issue #{0}，感谢反馈！", error_too_short: "标题或描述太短，请再写详细一点。", error_failed: "提交失败，请稍后重试。", aria_open: "打开意见反馈" },
    ...
    en: {
        ...
        modal: { add_perfume: "Add Perfume", edit_perfume: "Edit Perfume", perfume_name: "Perfume Name", brand: "Brand", top_notes: "Top Notes", middle_notes: "Heart Notes", base_notes: "Base Notes", select_placeholder: "Click to select...", select_ingredient: "Select Ingredient", ai_lookup: "✨ Auto-detect notes with AI", ai_lookup_loading: "AI looking up…", ai_lookup_hint: "Fill in the name (and ideally the brand), then click — AI will populate top/heart/base, you can still edit.", ai_lookup_need_input: "Enter a perfume name (brand helps too).", ai_lookup_no_match: "AI couldn't find reliable notes — try a different spelling or pick manually.", ai_lookup_failed: "Lookup failed, please try again.", ai_lookup_success: "Auto-filled {0} notes — feel free to tweak.", clear_notes: "Clear all", notes_cleared: "All notes cleared", ai_preview_title: "AI Result", ai_preview_cancel: "Cancel", ai_preview_apply: "Apply to form", ai_preview_disclaimer: "AI-generated, please verify against official sources before saving.", ai_preview_citations: "Sources:", confidence_high: "High confidence", confidence_medium: "Medium confidence", confidence_low: "Low confidence — use with caution" },
        auth: { login_tab: "Login", register_tab: "Register", email: "Email", password: "Password", confirm_password: "Confirm Password", username: "Username", login_btn: "Login", register_btn: "Register Now", logging_in: "Signing in…", registering: "Signing up…", logout_confirm: "Are you sure you want to logout?", logout_btn: "Sign Out", forgot: "Forgot password?", or: "OR", google: "Sign in with Google" },
        common: { cancel: "Cancel", save: "Save", done: "Done", all: "All" },
        advisor: { open: "✨ Ask the AI advisor", title: "AI Fragrance Advisor", subtitle: "Answers grounded in this collection's perfumes, soul notes, and co-occurrences.", input_placeholder: "e.g. Based on this collection, recommend a few Le Labo scents", send: "Send", sending: "Thinking…", thinking: "Advisor is thinking…", empty: "Ask anything — e.g. \"Based on this collection, recommend three Diptyque scents\", \"What summer perfume fits this profile?\", \"What occasion suits this taste?\"", error: "Failed to get a reply, please try again.", empty_collection: "This collection is empty — the advisor will give generic suggestions.", disclaimer: "Replies are AI-generated, for reference only.", suggestions: ["Recommend three Le Labo perfumes for this collection's taste", "What summer perfume fits this profile?", "What occasion suits this taste?", "Perfumes similar to these soul notes but warmer?"] },
        social_card: { like_hint: "Sign in and verify your email to like", like_need_verify: "Verify your email first to like", comments_title: "Comments", comment_placeholder: "Say something…", comment_hint: "Sign in and verify your email to comment", comment_submit: "Send", comment_need_verify: "Verify your email first to comment", comment_too_short: "Comment too short, please add a few more words.", comment_failed: "Failed to send comment, please try again.", comment_posted: "Sent", comment_report: "Report", comment_delete: "Delete", comment_report_confirm: "Report this comment? It will be hidden from others immediately.", comment_delete_confirm: "Delete your comment?", comment_reported: "Reported and hidden", comment_deleted: "Deleted", comment_hidden_tag: "Hidden by report", comments_empty: "No comments yet. Be the first to chime in." },
        feedback: { title: "Feedback", intro: "Share product ideas, bug reports, or UI suggestions. Your message becomes a GitHub Issue we can track.", category: "Category", cat_feature: "Feature idea", cat_bug: "Bug report", cat_ui: "UI / Visual", cat_other: "Other", field_title: "Title", field_desc: "Details", field_contact: "Contact (optional)", submit: "Send feedback", submitting: "Sending…", disclaimer: "Your message is filed as a public GitHub Issue, please avoid sensitive info.", success: "Thanks! Your feedback was sent.", success_with_link: "Created issue #{0}, thanks!", error_too_short: "Title or description is too short, please add a bit more detail.", error_failed: "Submission failed, please try again.", aria_open: "Open feedback" },
