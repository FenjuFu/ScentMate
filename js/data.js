...
export const TRANSLATIONS = {
    zh: {
        ...
        card: { overview: "气味概览", top_scents: "灵魂香调 (Top 3)", top_pairs: "经典和弦", generated_by: "基于你收藏的香水成分生成", find_match: "寻找共鸣者", perfumes: "收藏香水", scents: "独特气味", bottles: "瓶", types: "种", explorer: "气味探索者", default_quote: "在气味的迷宫中，你找到了属于自己的线索。", music_kicker: "古典音乐配对", music_link: "打开公开链接", music_fallback_title: "暂未匹配到音乐", music_fallback_reason: "等这张气味名片更完整一点，再为它找一首真正贴合的古典作品。" },
    ...
    en: {
        ...
        card: { overview: "Overview", top_scents: "Soul Notes", top_pairs: "Signature Chords", generated_by: "Generated based on your collection", find_match: "Find Resonance", perfumes: "Perfumes", scents: "Unique Scents", bottles: "bottles", types: "types", explorer: "Scent Explorer", default_quote: "In the labyrinth of scents, you found your thread.", music_kicker: "Classical Pairing", music_link: "Open Public Link", music_fallback_title: "No music pairing yet", music_fallback_reason: "Let this card settle a little more, then it will be easier to match it with the right classical work." },
